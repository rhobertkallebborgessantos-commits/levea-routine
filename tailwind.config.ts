  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // LEVEA custom colors
        levea: {
          sage: "hsl(var(--levea-sage))",
          "sage-light": "hsl(var(--levea-sage-light))",
          cream: "hsl(var(--levea-cream))",
          warm: "hsl(var(--levea-warm))",
          mint: "hsl(var(--levea-mint))",
          rose: "hsl(var(--levea-rose))",
          lavender: "hsl(var(--levea-lavender))",
          sky: "hsl(var(--levea-sky))",
        },
        // Time block colors
        morning: {
        ...
        evening: {
          ...
          foreground: "hsl(var(--evening-foreground))",
        },
        success: {
